...
export const MOCK_SNIPS = [
  { id:'s1', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.9, windKt:11, windDir:'SW', swellFt:3.1, periodS:8 } },
  { id:'s2', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.2, windKt:9, windDir:'S', swellFt:2.8, periodS:9 } },
  { id:'s3', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.0, windKt:8, windDir:'SSW', swellFt:2.5, periodS:8 } },
];
...
export const MOCK_ABFI = [
  { id:'a1', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.7, windKt:12, windDir:'SW', swellFt:3.0, periodS:8 }, offlineCaptured:false },
  { id:'a2', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.5, windKt:11, windDir:'SW', swellFt:3.0, periodS:8 }, offlineCaptured:true },
  { id:'a3', createdAtIso:new Date().toISOString(),
    ...
    conditions:{ sstF:68.6, windKt:12, windDir:'SW', swellFt:3.2, periodS:8 }, offlineCaptured:false },
];
