        ...
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="bg-black/60 backdrop-blur-md rounded-lg border border-cyan-500/20 p-4">
              ...
              <div className="space-y-2">
                {mockPatternAlerts.map((alert, idx) => (
                  <div key={idx} className="flex items-center gap-3 p-2 bg-black/40 rounded border border-cyan-500/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            {showSpeciesMovement ? (
              ...
              <div className="bg-black/60 backdrop-blur-md rounded-lg border border-gray-700/20 p-4">
                <div className="flex items-center justify-between mb-3">
